...
# Resize the template to change its size
resized_template = cv.resize(img_gray_template, (new_width, new_height))  # Set new_width and new_height as desired
...
try:
    while True:
        ...
        if distance < distance_threshold:
            ...
            res = cv.matchTemplate(img_gray_segmented, resized_template, cv.TM_CCOEFF_NORMED)
